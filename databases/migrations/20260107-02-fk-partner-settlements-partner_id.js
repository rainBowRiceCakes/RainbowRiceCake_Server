/**
 * @file databases/migrations/20260107-02-fk-partner-settlements-partner_id.js
 * @description Add fk on partnerSettlemnets.partner_id
...
// Constraint 명
const constraintName = 'fk_partner_settlements_partner_id';

// Constraint 정의
const options = {
  fields: ['partner_id'], // fk 부여할 컬럼
  type: 'foreign key', // constraint 종류
  name: constraintName, // constraint명 지정
  references: { // 참조 설정
    table: 'partners', // 참조할 테이블
    field: 'id', // 참조 컬럼 지정
  },
