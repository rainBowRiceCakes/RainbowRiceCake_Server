/**
 * @file app/middlewares/multer/uploaders/question.uploader.js
 * @description question 이미지 업로더
  ...
  const upload = multer({
    ...
    storage: multer.diskStorage({
      ...
      destination(req, file, callback) {
        const fullPath = pathUtil.getQuestionsImagePath();
    ...
    limits: {
      fileSize: parseInt(process.env.FILE_QUESTION_IMAGE_SIZE)
    }
  }).single('qnaImg'); // 컬럼 이름이랑 동일해야해!!!!!!!
