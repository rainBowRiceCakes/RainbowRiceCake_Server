...
import questionsController from '../app/controllers/reports.controller.js';
 ...
 */
questionRouter.post('/question-requests', authMiddleware, storeValidator, validationHandler, questionsController.store);
